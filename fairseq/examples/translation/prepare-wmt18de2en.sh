...
URLS=(
    ...
    "http://statmt.org/wmt15/dev-v2.tgz"
...
for l in $src $tgt; do
    awk '{if (NR%400 == 0)  print $0; }' $tmp/train.tags.$lang.tok.$l > $tmp/valid.$l
    awk '{if (NR%4 == 0 && NR%400 != 0)  print $0; }' $tmp/train.tags.$lang.tok.$l > $tmp/train.$l
done
